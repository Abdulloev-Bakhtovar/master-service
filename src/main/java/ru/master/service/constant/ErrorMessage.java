...
public class ErrorMessage {
    ...
    public static final String SERVICE_CATEGORY_ALREADY_EXISTS = "Service category already exists";
    public static final String SUB_SERVICE_CATEGORY_ALREADY_EXISTS = "Sub service category already exists";
    public static final String ORDER_NOT_FOUND = "Order not found";
    public static final String MASTER_REQUEST_NOT_FOUND = "Master request not found";
